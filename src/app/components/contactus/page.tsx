      ...
      <div className="w-full bg-gray-50">
        ...
        <div className="bg-gray-200 py-8">
          <div className="max-w-screen-xl mx-auto px-4">
            <h1 className="text-3xl sm:text-4xl font-bold text-[#101750] mb-2">Contact Us</h1>
        ...
        <div className="max-w-screen-xl mx-auto px-4 py-12 flex flex-col lg:flex-row gap-12">
          {/* Left Section */}
          <div className="flex-1 lg:w-1/2">
            {/* Information About Us */}
            <h2 className="text-2xl sm:text-3xl font-bold text-[#151875] mb-4">Information About Us</h2>
            ...
            {/* Get in Touch */}
            <h2 className="text-2xl sm:text-3xl font-bold text-[#151875] mb-4">Get in Touch</h2>
            <p className="text-gray-600 mb-6">
          ...
          <div className="flex-1 lg:w-1/2">
            ...
            <div className="mt-8">
              <Image
                src="/images/apple (1).png" // Reference the image using its path in the public folder
                alt="Connect"
                width={500} // Adjust the width as needed
                height={500} // Adjust the height as needed
                className="w-full sm:w-80 md:w-96 lg:w-full"
              />
            </div>
          </div>
        </div>
